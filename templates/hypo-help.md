...
| Command | Description |
|---------|-------------|
| `/hypo:crystallize` | Close a session (steps 1-6, a mandatory checklist) and, on request, surface synthesis candidates (steps 7-11) — tag clusters, unlinked pages, drafts |
